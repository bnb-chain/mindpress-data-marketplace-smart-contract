...
const config: HardhatUserConfig = {
    ...
    networks: {
        ...
        'bsc-testnet': {
            url: process.env.RPC_TESTNET || 'https://data-seed-prebsc-1-s1.binance.org:8545/',
            accounts: [
                process.env.OP_PRIVATE_KEY || '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80',
                process.env.OWNER_PRIVATE_KEY || '0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d',
                process.env.USER_PRIVATE_KEY || '0x2a871d0798f97d79848a013d4936a73bf4cc922c825d33c1cf7073dff6d409c6',
                '0x23400f0b4857a2228218fa74fbcac1f2285c03e60d590afe8fa3dc93692aa7be', // faucet
        ...
        'goerli': {
            ...
            accounts: [
                process.env.OP_PRIVATE_KEY || '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80',  // developer
            ]
        },
        'opbnb': {
